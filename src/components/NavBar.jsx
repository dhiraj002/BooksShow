                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
                    <div className="flex min-h-[4rem] md:min-h-[5rem] items-center justify-between flex-wrap gap-y-3 gap-x-4 py-2">
                        ...
                        <div
                            ...
                            style={{ "--mouse-x": "0px", "--mouse-y": "0px", background: isHovered ? `radial-gradient(400px circle at var(--mouse-x) var(--mouse-y), rgba(59 ,130,246,0.4),transparent 40%)` : "transparent" }}
                        >
